...
const boardType = route.path.includes('/qa') ? 'qa' : 'community';

const postsData = {
  qa: [
    { id: 1, title: '첫 번째 질문', content: '질문 내용입니다.', comments: [] },
    { id: 2, title: '두 번째 질문', content: '질문 내용입니다.', comments: [] },
    // 추가 질문 데이터
  ],
  community: [
...
const posts = ref(postsData[boardType]);
